...
namespace VerificationCode
{
    public class VerificationCodeImage
    {
        ...
        public static Task<VerificationCodeModel> CreateHanZi(int numbers = 5, int _height = 200, int _width = 200)
        {
            ...
            //string _base = Environment.CurrentDirectory;
            string _base=@"vimages";
            _base = PathHelper.urlConvertorLocal(_base);
    ...
    public class VerificationCodeModel
    {
        ...
        public List<Point_X_Y> point_X_Y = new List<Point_X_Y>();
