...
namespace VerificationCode
{
    public class VerificationCodeAESHelp
    {
        ...
        public VerificationCodeAESHelp(HttpContext httpContextAccessor)
        {
        ...
        {
            CookieHelper.SetCookie(key,value,DateTime.Now.AddMinutes(minute));
        }
        ...
        {
           return CookieHelper.GetCookieValue(key);
        }
    }
}